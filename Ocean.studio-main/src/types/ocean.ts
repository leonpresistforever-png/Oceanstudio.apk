export interface OceanAPI {
  ...
  cloudshell: {
    authenticate: () => Promise<CloudShellStatus>;
    activate: () => Promise<CloudShellStatus>;
    getStatus: () => Promise<CloudShellStatus>;
  ...
  nativeSetup?: {
    setup: () => Promise<{ ready: boolean; prefix: string; shell: string; message: string }>;
    getStatus: () => Promise<{ ready: boolean; prefix: string; shell: string; message: string }>;
  };
  plugins?: {
