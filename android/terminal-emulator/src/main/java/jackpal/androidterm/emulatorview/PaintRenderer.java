...
class PaintRenderer extends BaseTextRenderer {
    ...
    public void drawTextRun(Canvas canvas, float x, float y, int lineOffset,
        ...
        mTextPaint.setColor(resolveColor(backColor));
        ...
        if (!invisible) {
            ...
            if (foreColor < 8 && bold) {
                ...
                textPaintColor = resolveColor(foreColor+8);
            } else {
                textPaintColor = resolveColor(foreColor);
            }
            ...
            if (cursorVisible) {
                ...
                // Text at cursor
                mTextPaint.setColor(resolveColor(TextStyle.ciCursorForeground));
