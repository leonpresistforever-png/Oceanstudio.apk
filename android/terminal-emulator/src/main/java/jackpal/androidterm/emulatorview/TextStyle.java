...
final class TextStyle {
    ...
    // The packed style has nine color-index bits. Indices 260..511 are an
    // exact dynamic true-color cache maintained by BaseTextRenderer.
    final static int ciColorLength = 512;
